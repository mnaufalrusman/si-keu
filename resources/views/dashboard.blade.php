                ...
                <div class="col-md-4">
                    <div class="card card-hero">
                        <div class="card-header">
                            ...
                            <div class="card-description">Catatan</div>
                        </div>
                                ...
                                @foreach ($orderNotes as $orderNote)
                                    <a href="#" class="ticket-item">
                                        <div class="ticket-title">
                                            <h4>{{ $orderNote->name }}</h4>
                                        </div>
                                        <div class="ticket-info">
                                            <div>{{ $orderNote->author }}</div>
                                            <div class="bullet"></div>
                                            <div class="text-primary">{{ $orderNote->created_at->format('M d Y') }}
                                            </div>
                                        </div>
                                    </a>
                                @endforeach
                                <a href="/note" class="ticket-item ticket-more">
